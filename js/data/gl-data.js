...
window.GL = {
  ...
  projects: [
    ...
    { id: 'kairos',       icon: 'K·O',       color: '#7aae8a', page: 'pages/projects/kairos.html',       updated_at: '2026-06-08', order: 5 }
  ],
    ...
    it: {
      ...
      projects: {
        ...
        kairos: {
          ...
          description: 'KAIROS e un progetto concettuale dedicato a un sistema ontologico di inferenza causale adattiva: una geometria interna capace di distinguere struttura, novita e coerenza dal semplice rumore statistico.',
          status: 'concept',
          tags: ['AI', 'Inferenza', 'Causalita', 'Ontologia'],
          links: { site: '#', github: '#', docs: '#' }
        }
      },
      status: { active: 'Attivo', development: 'In sviluppo', ongoing: 'In corso', concept: 'Concetto', archived: 'Archiviato' },
      about: {
    ...
    en: {
      ...
      projects: {
        ...
        kairos: {
          ...
          status: 'concept',
          tags: ['AI', 'Inference', 'Causality', 'Ontology'],
          links: { site: '#', github: '#', docs: '#' }
        }
      },
      status: { active: 'Active', development: 'In development', ongoing: 'Ongoing', concept: 'Concept', archived: 'Archived' },
      about: {
